...
Page(app.assign({
  ...
  onShow: function() {
    this.setData({
      postsList: wx.getStorageSync(`selectPosts_list`)
    })
  ...
  getPostsList(page, label) {
    app._func.posts_list.call(this, page, '', res => {}, 1)
  },

  // 加载更多
  loadMore() {
    app.loadMore(this, `postsList`, (currentPage) => {
      this.getPostsList(currentPage, '', res => {}, 1)
    })
  },
  ...
  clearRedPoint() {
    ...
    if (subsection_message) {
      subsection_message.label = false;
